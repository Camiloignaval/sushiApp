export const ConectorPlugin = (() => {
  ...
  class ConectorPlugin {
    ...
    static obtenerImpresoras(ruta) {
      ...
      return fetch(ConectorPlugin.URL_PLUGIN_POR_DEFECTO + "/impresoras").then(
        (r) => r.json()
      );
    }
    ...
    textoConAcentos(texto) {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionTextoConAcentos,
          texto
        )
      );
      return this;
    ...
    feed(n) {
      ...
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionFeed,
          n
        )
      );
      return this;
    ...
    establecerTamanioFuente(multiplicadorAncho, multiplicadorAlto) {
      ...
      if (multiplicadorAncho < 1 || multiplicadorAncho > 8)
        throw "El multiplicador de ancho está fuera del rango";
      if (multiplicadorAlto < 1 || multiplicadorAlto > 8)
        throw "El multiplicador de alto está fuera del rango";
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionTextSize,
          `${multiplicadorAncho},${multiplicadorAlto}`
        )
      );
      return this;
    }
    ...
    establecerFuente(font) {
      if (
        font !== ConectorPlugin.Constantes.FuenteA &&
        font !== ConectorPlugin.Constantes.FuenteB &&
        font !== ConectorPlugin.Constantes.FuenteC
      )
        throw Error("Fuente inválida");
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionFont,
          font
        )
      );
      return this;
    ...
    establecerEnfatizado(val) {
      ...
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionEmphasize,
          val
        )
      );
      return this;
    ...
    establecerJustificacion(justification) {
      if (
        justification !== ConectorPlugin.Constantes.AlineacionCentro &&
        justification !== ConectorPlugin.Constantes.AlineacionDerecha &&
        justification !== ConectorPlugin.Constantes.AlineacionIzquierda
      ) {
        throw Error(`Alineación ${justification} inválida`);
      }
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionJustification,
          justification
        )
      );
      return this;
    ...
    cortar() {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionCut,
          ""
        )
      );
      return this;
    ...
    abrirCajon() {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionPulse,
          ""
        )
      );
      return this;
    ...
    cortarParcialmente() {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionCutPartial,
          ""
        )
      );
      return this;
    ...
    imagenDesdeUrl(url) {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionImagen,
          url
        )
      );
      return this;
    ...
    imagenLocal(ubicacion) {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionImagenLocal,
          ubicacion
        )
      );
      return this;
    ...
    qr(contenido) {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionQr,
          contenido
        )
      );
      return this;
    ...
    qrComoImagen(contenido) {
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(
          ConectorPlugin.Constantes.AccionQrComoImagen,
          contenido
        )
      );
      return this;
    ...
    codigoDeBarras(contenido, tipo) {
      ...
      this.operaciones.push(
        new ConectorPlugin.OperacionTicket(tipo, contenido)
      );
      return this;
    }
